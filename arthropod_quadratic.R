...
ly1=ggplot(lyc_dat, aes(x=DOY, y=log(TotalCatch1), col=as.factor(Year)))+geom_point()+facet_wrap(~Plot.ID)+
    ggtitle("Lycosidae")+scale_colour_viridis_d()
...
col_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
                 DOYs*years + # timing and long-term trend interaction
                 poly(DOYs, 2)* years+ #curve and long-term trend interaction
              (years|Plot.ID), #random effects to account for plot-level differences in trends
...
#Acari
aca_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
aca_plot1=ggplot(aca_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Acari")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Ichneumonidae
ich_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
ich_plot1=ggplot(ich_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Ichneumonidae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Bombus
bom_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
bom_plot1=ggplot(bom_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Bombus")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")
...
lyc_plot1=ggplot(lyc_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Lycosidae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Sciaridae
sci_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
sci_plot1=ggplot(sci_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Sciaridae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Phoridae
pho_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
pho_plot1=ggplot(pho_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Phoridae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Nymphalidae
nym_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
nym_plot1=ggplot(nym_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Nymphalidae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Muscidae
mus_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
mus_plot1=ggplot(mus_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Muscidae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Linyphiidae
lin_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
lin_plot1=ggplot(lin_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Linyphiidae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)


#Culicidae
cul_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
cul_plot1=ggplot(cul_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Culicidae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Chironomidae
chi_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
chi_plot1=ggplot(chi_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Chironomidae")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")

#Coccoidea
coc_mod=glmer(TotalCatch1~ DOYs+ poly(DOYs,2) + years + # base linear terms
              DOYs*years + # timing and long-term trend interaction
              poly(DOYs, 2)* years+(years|Plot.ID), #curve and long-term trend interaction
...
coc_plot1=ggplot(coc_preds, aes(x=DOY, y=preds, col=as.factor(Year)))+geom_line()+
  theme_classic()+ggtitle("Coccoidea")+scale_color_viridis_d()+facet_wrap(~Plot.ID)
#  geom_point(aes(x=DOY, y=TotalCatch1), col="black")
