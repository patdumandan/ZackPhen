...
transformed parameters {
  ...
  vector[Nyr] width = exp(width_bar + sigma_width*width_raw); // year-specific phenology widths
...
model {
  ...
  // width of phenology
  width_bar ~ normal(log(6), 0.25); //or 0,2
  sigma_width ~ normal(0, 0.15);//student_t(4, 0, 0.2);
